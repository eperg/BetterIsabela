...
FIL2 = {
    ...
    "ObR duly signed by the Provincial Budget Officer": "ObR na wastong nilagdaan ng Provincial Budget Officer",
    ...
    "Processing of salaries, wages, and other compensation for provincial employees": "Pagproseso ng mga sahod, suweldo, at iba pang kabayaran para sa mga empleyado ng munisipyo",
    ...
    "Registration of birth for children born in Isabela": "Pagpaparehistro ng kapanganakan para sa mga batang ipinanganak sa Isabela",
    "Registration of death for persons who died in Isabela": "Pagpaparehistro ng pagkamatay para sa mga taong namatay sa Isabela",
    ...
    "Certification that a person has no declared property in Isabela.": "Sertipikasyon na ang isang tao ay walang idineklaang ari-arian sa Isabela.",
    ...
    "Application for Marriage License duly signed by the couple and the PCRC": "Aplikasyon para sa Lisensya sa Kasal na wastong nilagdaan ng mag-asawa at ng PCRC",
    ...
    "For engaged couples intending to get married in Isabela": "Para sa mga magkasintahang nagbabalak magpakasal sa Isabela",
    "After the PMC, go back to MCRO": "Pagkatapos ng PMC, bumalik sa MCRO",
    "PHO Certification of Cause of Death": "Sertipikasyon ng PHO ng Sanhi ng Pagkamatay",
    ...
    "Get your copy of COM duly registered and signed by the Receiving Officer and PCRC or any authorized staff": "Kunin ang iyong kopya ng COM na wastong nairehistro at nilagdaan ng Receiving Officer at PCRC o sinumang awtorisadong kawani",
...
FIL3 = {
    # Business/Permits
    "Application for new business permit for businesses operating in Isabela": "Aplikasyon para sa bagong permiso sa negosyo para sa mga negosyong nag-ooperate sa Isabela",
    ...
    "Business permits, Governor's clearance, licensing": "Mga permiso sa negosyo, clearance ng Alkalde, paglilisensya",
    ...
    "What do I need to start a new business in Isabela?": "Ano ang kailangan ko upang magsimula ng bagong negosyo sa Isabela?",
    ...
    "Tax declaration form for real property assessment in Isabela": "Form ng tax declaration para sa pagtatasa ng tunay na ari-arian sa Isabela",
    ...
    "Visit the Provincial Treasurer's Office at the Provincial Capitol with your Tax Declaration or latest Official Receipt": "Bumisita sa Opisina ng Ingat-Yaman ng Munisipyo sa Munisipyo na may iyong Tax Declaration o pinakabagong Opisyal na Resibo",
...
FIL4 = {
    ...
    "Approval and signing by PSWDO Head": "Pag-apruba at pagpirma ng Pinuno ng PSWDO",
    ...
    "Report/seek assistance at PSWDO": "Mag-ulat/humingi ng tulong sa PSWDO",
    ...
    "Proof of residence in Isabela": "Patunay ng paninirahan sa Isabela",
...
FIL5 = {
    ...
    "Farm registration, certifications, and agricultural programs for Isabela farmers": "Pagpaparehistro ng bukid, mga sertipikasyon, at mga programang agrikultural para sa mga magsasaka ng Isabela",
    ...
    "Slaughter permit from the Provincial Agriculturist": "Permiso sa pagkatay mula sa Provincial Agriculturist",
    ...
    "Support programs for corn farmers in Isabela": "Mga programa ng suporta para sa mga magsasaka ng mais sa Isabela",
    ...
    "Carabao slaughter requires special permit from Provincial Agriculturist": "Ang pagkatay ng kalabaw ay nangangailangan ng espesyal na permiso mula sa Provincial Agriculturist",
...
FIL6 = {
    ...
    "Construction and agricultural equipment for provincial projects": "Mga kagamitan sa konstruksyon at agrikultura para sa mga proyekto ng munisipyo",
    "Equipment rental is subject to availability and approval. Priority is given to provincial projects and emergency situations": "Ang pag-upa ng kagamitan ay depende sa pagkakaroon at pag-apruba. Ang prayoridad ay ibinibigay sa mga proyekto ng munisipyo at mga sitwasyon ng emergency",
    "Management and maintenance of provincial vehicles and heavy equipment": "Pamamahala at pagpapanatili ng mga sasakyan at mabibigat na kagamitan ng munisipyo",
    "Regular maintenance and repair coordination": "Regular na pagpapanatili at koordinasyon ng pagkukumpuni",
    "Request letter addressed to the Provincial Governor stating purpose and date of use": "Sulat ng kahilingan na nakadirekta sa Punong Bayan na nagsasaad ng layunin at petsa ng paggamit",
    ...
    "Management and monitoring of provincial utility accounts including electricity, water, and telephone": "Pamamahala at pagsubaybay ng mga account ng utilidad ng munisipyo kabilang ang kuryente, tubig, at telepono",
    ...
    "Procurement and distribution of common-use supplies and materials for provincial offices": "Pagkuha at pamamahagi ng mga karaniwang suplay at materyales para sa mga opisina ng munisipyo",
    ...
    "The GSO assists in the procurement process for provincial supplies, equipment, and services in accordance with RA 9184": "Ang GSO ay tumutulong sa proseso ng pagkuha para sa mga suplay, kagamitan, at serbisyo ng munisipyo alinsunod sa RA 9184",
    "The Provincial General Services Office takes custody of all properties, real or personal, owned by the province": "Ang Opisina ng Pangkalahatang Serbisyo ng Munisipyo ay nag-iingat ng lahat ng ari-arian, tunay o personal, na pagmamay-ari ng munisipyo",
    ...
    "Citizens can attend Sangguniang Panlalawigan sessions and participate in public hearings for proposed ordinances": "Ang mga mamamayan ay maaaring dumalo sa mga sesyon ng Sangguniang Panlalawigan at lumahok sa mga pagdinig publiko para sa mga iminumungkahing ordinansa",
    ...
    "Committee submits findings and recommendations to the Sangguniang Panlalawigan": "Isinusumite ng komite ang mga natuklasan at rekomendasyon sa Sangguniang Panlalawigan",
    ...
    "Final voting on the proposed ordinance by the Sangguniang Panlalawigan": "Huling pagboto sa iminumungkahing ordinansa ng Sangguniang Panlalawigan",
    ...
    "Learn about the legislative process of the Sangguniang Panlalawigan": "Alamin ang tungkol sa prosesong lehislatibo ng Sangguniang Panlalawigan",
    ...
    "Governor reviews and approves the enacted ordinance within 10 days": "Sinusuri at inaprubahan ng Alkalde ang naipatupad na ordinansa sa loob ng 10 araw",
    "Provincial ordinances enacted by the Sangguniang Panlalawigan — local laws that govern the province": "Mga ordinansa ng munisipyo na naipatupad ng Sangguniang Panlalawigan — mga lokal na batas na namamahala sa munisipyo",
    "Ordinance takes effect and is enforced within the province": "Ang ordinansa ay nagkakabisa at ipinapatupad sa loob ng munisipyo",
    ...
    "Resolution is scheduled for inclusion in the Sangguniang Panlalawigan session": "Ang resolusyon ay naka-iskedyul para sa pagsasama sa sesyon ng Sangguniang Panlalawigan",
    "Resolutions passed by the Sangguniang Panlalawigan expressing the will or opinion of the legislative body on various matters.": "Mga resolusyong ipinasa ng Sangguniang Panlalawigan na nagpapahayag ng kalooban o opinyon ng lehislatura sa iba't ibang usapin.",
    ...
    "Submit the proposed ordinance to the Sangguniang Panlalawigan for consideration": "Isumite ang iminumungkahing ordinansa sa Sangguniang Panlalawigan para sa pagsasaalang-alang",
    "Submit the proposed resolution to the Sangguniang Panlalawigan": "Isumite ang iminumungkahing resolusyon sa Sangguniang Panlalawigan",
    ...
    "Sangguniang Panlalawigan Members approve the MTOF": "Ang mga Miyembro ng Sangguniang Panlalawigan ay inaprubahan ang MTOF",
    "Vice Governor or Secretary to the Sanggunian approves/disapproves the request": "Ang Bise Alkalde o Kalihim ng Sanggunian ay inaprubahan/tinanggihan ang kahilingan",
    ...
    "The Provincial Budget Office assists barangays in the preparation of their Annual Budget. It conducts review and evaluation": "Ang Opisina ng Badyet ng Munisipyo ay tumutulong sa mga barangay sa paghahanda ng kanilang Taunang Badyet. Nagsasagawa ito ng pagsusuri at ebalwasyon",
    "The Provincial Budget Office processes disbursement vouchers particularly the integral part of Obligation Request": "Ang Opisina ng Badyet ng Munisipyo ay nagpoproseso ng mga disbursement voucher lalo na ang mahalagang bahagi ng Obligation Request",
    "The Provincial Accounting Office pre-audits disbursement vouchers to ensure compliance with accounting rules": "Ang Opisina ng Accounting ng Munisipyo ay nag-pre-audit ng mga disbursement voucher upang matiyak ang pagsunod sa mga patakaran ng accounting",
...
FIL7 = {
    # Privacy Policy
    "This Privacy Policy explains how BetterIsabela.org collects, uses, and protects your information": "Ang Patakaran sa Privacy na ito ay nagpapaliwanag kung paano kinokolekta, ginagamit, at pinoprotektahan ng BetterIsabela.org ang iyong impormasyon",
    ...
    "These Terms of Use govern your access to and use of the BetterIsabela.org website": "Ang mga Tuntunin ng Paggamit na ito ay namamahala sa iyong pag-access at paggamit ng website ng BetterIsabela.org",
    ...
    "All content on this website is the property of BetterIsabela.org unless otherwise stated": "Ang lahat ng nilalaman sa website na ito ay pag-aari ng BetterIsabela.org maliban kung iba ang nakasaad",
    ...
    "Find answers to common questions about Isabela provincial services": "Maghanap ng mga sagot sa mga karaniwang tanong tungkol sa mga serbisyo ng munisipyo ng Isabela",
    "Is this website mobile-friendly?": "Ang website ba na ito ay mobile-friendly?",
    "Who developed Better Isabela?": "Sino ang gumawa ng Better Isabela?",
    ...
    "How do I contact the provincial government?": "Paano ako makikipag-ugnayan sa pamahalaang munisipal?",
    "What services are available online?": "Anong mga serbisyo ang magagamit online?",
    "Where is the Provincial Capitol located?": "Nasaan ang Munisipyo?",
    ...
    # Statistics
    "Provincial Statistics": "Estadistika ng Munisipyo",
    "Data and statistics about Isabela": "Datos at estadistika tungkol sa Isabela",
    ...
    "Isabela at a Glance": "Isabela sa Isang Tingin",
    "Brief History of Isabela": "Maikling Kasaysayan ng Isabela",
    "Major development projects serving the community": "Mga pangunahing proyekto ng pagpapaunlad na nagsisilbi sa komunidad",
    "DPWH Infrastructure Projects in Isabela": "Mga Proyekto ng Imprastraktura ng DPWH sa Isabela",

    # Home page
    "Welcome to Better Isabela": "Maligayang Pagdating sa Better Isabela",
    "Your gateway to Isabela provincial services and information": "Ang iyong daan patungo sa mga serbisyo at impormasyon ng munisipyo ng Isabela",
    "Fetching news and updates from Isabela.": "Kinukuha ang mga balita at update mula sa Isabela.",
    "Fetching the latest news from Isabela.": "Kinukuha ang pinakabagong balita mula sa Isabela.",
    "Stay informed about the latest happenings in Isabela": "Manatiling may kaalaman tungkol sa mga pinakabagong pangyayari sa Isabela",
    ...
    # Contact
    "Contact the Provincial Government": "Makipag-ugnayan sa Pamahalaang Munisipal",
    "Get in touch with the provincial government of Isabela": "Makipag-ugnayan sa pamahalaang munisipal ng Isabela",
    "Office Hours": "Oras ng Opisina",
    "Provincial Capitol Address": "Adres ng Munisipyo",
...
KEEP_AS_IS = {
    ...
    'PDRRMO', 'PSWDO', 'PEEDO', 'PPDO', 'BIR', 'DTI', 'SEC', 'DENR',
    'DPWH', 'DSWD', 'PSA', 'NBI', 'COA', 'CSC', 'DBM', 'DOH',
    'MTOF', 'BPLS', 'RPT', 'CTC', 'RPTA', 'Filipizen',
    'BetterIsabela.org', 'Better Isabela', 'Abakada.org',
    'Sangguniang Panlalawigan', 'Sangguniang Panlalawigan',
    'Cagayan Valley', 'Isabela', 'Bayombong', 'Facebook', 'Google',
}
