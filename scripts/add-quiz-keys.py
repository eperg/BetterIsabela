#!/usr/bin/env python3
"""
Add missing Isabela Quiz and Quiz CTA translation keys to translations.js.
"""
...
# All the page-prefix variants for "Isabela Quiz" footer link
prefixes = [
...
quiz_cta_en = {
    'home-isabela-quiz': 'Isabela Quiz',
    'home-how-well-do-you-know-isabela': 'How well do you know Isabela?',
    'home-evaluate-your-familiarity-with-the-provinces': "Evaluate your familiarity with the province's heritage, cultural identity, and geographic significance through an interactive knowledge assessment designed to showcase one of Cagayan Valley's most prominent localities.",
    'home-take-the-quiz': 'Take the Quiz',
}

quiz_cta_fil = {
    'home-isabela-quiz': 'Isabela Quiz',
    'home-how-well-do-you-know-isabela': 'Gaano mo kakilala ang Isabela?',
    'home-evaluate-your-familiarity-with-the-provinces': "Suriin ang iyong kaalaman sa pamana, pagkakakilanlan sa kultura, at kahalagahang heograpiko ng munisipalidad sa pamamagitan ng isang interactive na pagtatasa ng kaalaman na idinisenyo upang ipakita ang isa sa mga pinakatanyag na lokalidad ng Cagayan Valley.",
    'home-take-the-quiz': 'Subukin ang Quiz',
}

quiz_cta_ilo = {
    'home-isabela-quiz': 'Isabela Quiz',
    'home-how-well-do-you-know-isabela': 'Kasano ti pannakaammom iti Isabela?',
    'home-evaluate-your-familiarity-with-the-provinces': "Evaluaren ti pannakaammom iti tawid, kultural a pagbigbigan, ken heograpiko a kapatgan ti munisipalidad babaen ti maysa nga interactive a panagsubok ti pannakaammo a naidisinio tapno ipakita ti maysa kadagiti kalatakan a lokalidad ti Cagayan Valley.",
...
def build_entries(lang):
    ...
    # Page-prefix Isabela Quiz keys
    for prefix in prefixes:
        key = f'{prefix}-isabela-quiz'
        # "Isabela Quiz" stays the same in all languages (it's a proper name)
        entries.append(f'        "{key}": "Isabela Quiz"')
    
    # Quiz CTA keys
    if lang == 'en':
        for k, v in quiz_cta_en.items():
            # Skip home-isabela-quiz since it's already in the prefix list
            if k == 'home-isabela-quiz':
                continue
...
for k in ['home-take-the-quiz', 'home-how-well-do-you-know-isabela']:
