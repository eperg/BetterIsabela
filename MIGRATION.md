...
This document provides guidance for contributors migrating from the static HTML version to the React + TypeScript version of BetterIsabela.org.

## Overview

BetterIsabela.org now has two versions:
